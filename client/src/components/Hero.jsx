        ...
        <section className="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center text-center py-20 px-4">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
                    Chama Sync <br /> Management System
                </h2>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold py-3 px-8 rounded-lg text-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
                        Get Started Free
                    </button>
                    <button className="w-full sm:w-auto bg-white/20 hover:bg-white/30 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 backdrop-blur-sm">
                        Sign In
                    </button>
                </div>
            </div>
