...
import { ArrowLeft, User, Wallet, Calendar, CheckCircle } from 'lucide-react';
import Sidebar from './Sidebar'; // Assuming Sidebar is also modularized
import Header from './Header';   // Assuming Header is also modularized
        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            <div className="flex">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8">
                    <Header user={{ name: 'John' }} handleLogout={() => {}} navigate={navigate} />
